...
% Standard LaTeX packages (PDFLaTeX compatible)
...
% Code highlighting (simplified for PDFLaTeX)
\lstset{
    language=Python,
...
{\large A PDFLaTeX Technical Report}
}
...
\begin{lstlisting}[language=Python, caption=Multi-Teacher System Implementation]
...
\begin{lstlisting}[language=Python, caption=ΨQRH Student Model]
...
\begin{lstlisting}[language=Python, caption=Training Pipeline]
...
\begin{lstlisting}[language=bash, caption=Quick Start Installation]
...
\begin{lstlisting}[language=Python, caption=Advanced Configuration]
